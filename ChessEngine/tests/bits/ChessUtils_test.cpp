...
namespace bits {
    ...
    TEST_F(ChessUtils, getFileMask_File0_ShouldReturn0x8080808080808080) {
        U64 expected = 0x8080808080808080ULL;
        U64 actual = getFileMask(0);
        ASSERT_EQ(expected, actual);
    }

    TEST_F(ChessUtils, getFileMask_File1_ShouldReturn0x4040404040404040) {
        U64 expected = 0x4040404040404040ULL;
        U64 actual = getFileMask(1);
        ASSERT_EQ(expected, actual);
    }

    TEST_F(ChessUtils, getFileMask_File2_ShouldReturn0x2020202020202020) {
        U64 expected = 0x2020202020202020ULL;
        U64 actual = getFileMask(2);
        ASSERT_EQ(expected, actual);
    }

    TEST_F(ChessUtils, getFileMask_File3_ShouldReturn0x1010101010101010) {
        U64 expected = 0x1010101010101010ULL;
        U64 actual = getFileMask(3);
        ASSERT_EQ(expected, actual);
    }

    TEST_F(ChessUtils, getFileMask_File4_ShouldReturn0x0808080808080808) {
        U64 expected = 0x0808080808080808ULL;
        U64 actual = getFileMask(4);
        ASSERT_EQ(expected, actual);
    }

    TEST_F(ChessUtils, getFileMask_File5_ShouldReturn0x0404040404040404) {
        U64 expected = 0x0404040404040404ULL;
        U64 actual = getFileMask(5);
        ASSERT_EQ(expected, actual);
    }

    TEST_F(ChessUtils, getFileMask_File6_ShouldReturn0x0202020202020202) {
        U64 expected = 0x0202020202020202ULL;
        U64 actual = getFileMask(6);
        ASSERT_EQ(expected, actual);
    }

    TEST_F(ChessUtils, getFileMask_File7_ShouldReturn0x0101010101010101) {
