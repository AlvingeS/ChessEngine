...
//         io::fen::set_pos_from_fen(captures, pos);
//         moveGenerator.gen_moves(true, movelist);
...
//         io::fen::set_pos_from_fen(castling, pos);
//         moveGenerator.gen_moves(true, movelist);
...
//         io::fen::set_pos_from_fen(normalPromotion, pos);
//         moveGenerator.gen_moves(true, movelist);
...
//         io::fen::set_pos_from_fen(capturePromotion, pos);
//         moveGenerator.gen_moves(true, movelist);
...
//         io::fen::set_pos_from_fen(enPessant, pos);
