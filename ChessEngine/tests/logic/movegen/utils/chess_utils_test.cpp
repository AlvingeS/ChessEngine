...
TEST_F(ChessUtilsTest, getFileMask_File7_ShouldReturn0x8080808080808080)
{
    ...
    bitmask actual = chess_utils::get_file_mask(7);
...
TEST_F(ChessUtilsTest, getFileMask_File6_ShouldReturn0x4040404040404040)
{
    ...
    bitmask actual = chess_utils::get_file_mask(6);
    ASSERT_EQ(expected, actual);
}
...
TEST_F(ChessUtilsTest, getFileMask_File5_ShouldReturn0x2020202020202020)
{
    ...
    bitmask actual = chess_utils::get_file_mask(5);
    ASSERT_EQ(expected, actual);
}
...
TEST_F(ChessUtilsTest, getFileMask_File4_ShouldReturn0x1010101010101010)
{
    ...
    bitmask actual = chess_utils::get_file_mask(4);
    ASSERT_EQ(expected, actual);
}
...
TEST_F(ChessUtilsTest, getFileMask_File3_ShouldReturn0x0808080808080808)
{
    ...
    bitmask actual = chess_utils::get_file_mask(3);
    ASSERT_EQ(expected, actual);
}
...
TEST_F(ChessUtilsTest, getFileMask_File2_ShouldReturn0x0404040404040404)
{
    ...
    bitmask actual = chess_utils::get_file_mask(2);
    ASSERT_EQ(expected, actual);
}
...
TEST_F(ChessUtilsTest, getFileMask_File1_ShouldReturn0x0202020202020202)
{
    ...
    bitmask actual = chess_utils::get_file_mask(1);
    ASSERT_EQ(expected, actual);
}
...
TEST_F(ChessUtilsTest, getFileMask_File0_ShouldReturn0x0101010101010101)
{
    ...
    bitmask actual = chess_utils::get_file_mask(0);
    ASSERT_EQ(expected, actual);
}
...
TEST_F(ChessUtilsTest, getRankMask_Rank0_ShouldReturn0x00000000000000FF)
{
    ...
    bitmask actual = chess_utils::get_rank_mask(0);
    ASSERT_EQ(expected, actual);
}
...
TEST_F(ChessUtilsTest, getRankMask_Rank1_ShouldReturn0x000000000000FF00)
{
    ...
    bitmask actual = chess_utils::get_rank_mask(1);
    ASSERT_EQ(expected, actual);
}
...
TEST_F(ChessUtilsTest, getRankMask_Rank2_ShouldReturn0x0000000000FF0000)
{
    ...
    bitmask actual = chess_utils::get_rank_mask(2);
    ASSERT_EQ(expected, actual);
}
...
TEST_F(ChessUtilsTest, getRankMask_Rank3_ShouldReturn0x00000000FF000000)
{
    ...
    bitmask actual = chess_utils::get_rank_mask(3);
    ASSERT_EQ(expected, actual);
}
...
TEST_F(ChessUtilsTest, getRankMask_Rank4_ShouldReturn0x000000FF00000000)
{
    ...
    bitmask actual = chess_utils::get_rank_mask(4);
    ASSERT_EQ(expected, actual);
}
...
TEST_F(ChessUtilsTest, getRankMask_Rank5_ShouldReturn0x0000FF0000000000)
{
    ...
    bitmask actual = chess_utils::get_rank_mask(5);
    ASSERT_EQ(expected, actual);
}
...
TEST_F(ChessUtilsTest, getRankMask_Rank6_ShouldReturn0x00FF000000000000)
{
    ...
    bitmask actual = chess_utils::get_rank_mask(6);
    ASSERT_EQ(expected, actual);
}
...
TEST_F(ChessUtilsTest, getRankMask_Rank7_ShouldReturn0xFF00000000000000)
{
    ...
    bitmask actual = chess_utils::get_rank_mask(7);
    ASSERT_EQ(expected, actual);
}

    // chess_utils::rankFromBitIndex tests
TEST_F(ChessUtilsTest, rankFromBitIndex_Pos0_ShouldReturn0)
{
    int expected = 0;
    int actual = chess_utils::rank_from_sq(0);
    ASSERT_EQ(expected, actual);
}
...
{
    int expected = 0;
    int actual = chess_utils::rank_from_sq(7);
    ASSERT_EQ(expected, actual);
}
...
{
    int expected = 1;
    int actual = chess_utils::rank_from_sq(8);
    ASSERT_EQ(expected, actual);
}
...
{
    int expected = 1;
    int actual = chess_utils::rank_from_sq(15);
    ASSERT_EQ(expected, actual);
}
...
{
    int expected = 7;
    int actual = chess_utils::rank_from_sq(63);
    ASSERT_EQ(expected, actual);
}

// chess_utils::fileFromBitIndex tests
TEST_F(ChessUtilsTest, fileFromBitIndex_Pos0_ShouldReturn0)
{
    int expected = 0;
    int actual = chess_utils::file_from_sq(0);
    ASSERT_EQ(expected, actual);
}
...
{
    int expected = 7;
    int actual = chess_utils::file_from_sq(7);
    ASSERT_EQ(expected, actual);
}
...
{
    int expected = 0;
    int actual = chess_utils::file_from_sq(8);
    ASSERT_EQ(expected, actual);
}
...
{
    int expected = 7;
    int actual = chess_utils::file_from_sq(15);
    ASSERT_EQ(expected, actual);
}
...
{
    int expected = 7;
    int actual = chess_utils::file_from_sq(63);
    ASSERT_EQ(expected, actual);
}
...
TEST_F(ChessUtilsTest, getBitidxs_a_ShouldReturn0_8_10_16to23)
{
    ...
    bits::get_bit_idxs(actual, a_mask);
    ASSERT_EQ(expected, actual);
}
...
TEST_F(ChessUtilsTest, getBitidxs_b_ShouldReturnEmptyVector)
{
    ...
    std::vector<int> actual;
    bits::get_bit_idxs(actual, b_mask);
    ASSERT_EQ(expected, actual);
}
    ...
    for (int i = 0; i < 64; i++)
{
    ...
    std::vector<int> actual;
    bits::get_bit_idxs(actual, c_mask);
    ASSERT_EQ(expected, actual);
}
