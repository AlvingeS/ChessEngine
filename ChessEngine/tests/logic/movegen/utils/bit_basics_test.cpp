...
{
    bool expected = 0;
    bool actual = utils::get_bit(mask, 0);
...
{
    bool expected = 1;
    bool actual = utils::get_bit(mask, 9);
    ASSERT_EQ(expected, actual);
}
...
{
    bool expected = 1;
    bool actual = utils::get_bit(mask, 15);
    ASSERT_EQ(expected, actual);
}
...
{
    bool expected = 0;
    bool actual = utils::get_bit(mask, 16);
    ASSERT_EQ(expected, actual);
}
