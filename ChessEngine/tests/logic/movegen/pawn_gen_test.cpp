...
{
    io::Fen::set_board_from_fen(fenEnPessantForWhiteTest, bitboards, occupancy_masks, piece_map);
...
{
    io::Fen::set_board_from_fen(fenEnPessantForBlackTest, bitboards, occupancy_masks, piece_map);
...
{
    io::Fen::set_board_from_fen(fenPromotionTest, bitboards, occupancy_masks, piece_map);
    moveGenerator.gen_pawn_moves(true, movelist, 0);
...
{
    io::Fen::set_board_from_fen(fenBuggedPawnTest, bitboards, occupancy_masks, piece_map);
    moveGenerator.gen_pawn_moves(false, movelist, 0);
