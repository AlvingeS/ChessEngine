...
TEST_F(PawnBitmasksTest, getCapturePawnMovesBitmask_8asWhite_ShouldReturn0x0000000001030000) {
    ...
    bitmask actualCapture = PawnBitmasks::get_capture_pawn_moves_bitmask(8, true);
    bitmask actualStraight = PawnBitmasks::get_straight_pawn_moves_bitmask(8, true);
...
TEST_F(PawnBitmasksTest, getCapturePawnMovesBitmask_12asWhite_ShouldReturn0x0000000010380000) {
    ...
    bitmask actualCapture = PawnBitmasks::get_capture_pawn_moves_bitmask(12, true);
    bitmask actualStraight = PawnBitmasks::get_straight_pawn_moves_bitmask(12, true);
    ASSERT_EQ(expectedCapture, actualCapture);
    ASSERT_EQ(expectedStraight, actualStraight);
}
...
TEST_F(PawnBitmasksTest, getCapturePawnMovesBitmask_15asWhite_ShouldReturn0x0000000080C00000) {
    ...
    bitmask actualCapture = PawnBitmasks::get_capture_pawn_moves_bitmask(15, true);
    bitmask actualStraight = PawnBitmasks::get_straight_pawn_moves_bitmask(15, true);
    ASSERT_EQ(expectedCapture, actualCapture);
    ASSERT_EQ(expectedStraight, actualStraight);
}
...
TEST_F(PawnBitmasksTest, getCapturePawnMovesBitmask_20asWhite_ShouldReturn0x000000038000000) {
    ...
    bitmask actualCapture = PawnBitmasks::get_capture_pawn_moves_bitmask(20, true);
    bitmask actualStraight = PawnBitmasks::get_straight_pawn_moves_bitmask(20, true);
    ASSERT_EQ(expectedCapture, actualCapture);
    ASSERT_EQ(expectedStraight, actualStraight);
}
...
TEST_F(PawnBitmasksTest, getCapturePawnMovesBitmask_48asBlack_ShouldReturn0x000030100000000) {
    ...
    bitmask actualCapture = PawnBitmasks::get_capture_pawn_moves_bitmask(48, false);
    bitmask actualStraight = PawnBitmasks::get_straight_pawn_moves_bitmask(48, false);
    ASSERT_EQ(expectedCapture, actualCapture);
    ASSERT_EQ(expectedStraight, actualStraight);
}
...
TEST_F(PawnBitmasksTest, getCapturePawnMovesBitmask_52asBlack_ShouldReturn0x0000381000000000) {
    ...
    bitmask actualCapture = PawnBitmasks::get_capture_pawn_moves_bitmask(52, false);
    bitmask actualStraight = PawnBitmasks::get_straight_pawn_moves_bitmask(52, false);
    ASSERT_EQ(expectedCapture, actualCapture);
    ASSERT_EQ(expectedStraight, actualStraight);
}
...
TEST_F(PawnBitmasksTest, getCapturePawnMovesBitmask_55asBlack_ShouldReturn0x0000C08000000000) {
    ...
    bitmask actualCapture = PawnBitmasks::get_capture_pawn_moves_bitmask(55, false);
    bitmask actualStraight = PawnBitmasks::get_straight_pawn_moves_bitmask(55, false);
    ASSERT_EQ(expectedCapture, actualCapture);
    ASSERT_EQ(expectedStraight, actualStraight);
}
...
TEST_F(PawnBitmasksTest, getCapturePawnMovesBitmask_44asBlack_ShouldReturn0x0000003800000000) {
    ...
    bitmask actualCapture = PawnBitmasks::get_capture_pawn_moves_bitmask(44, false);
    bitmask actualStraight = PawnBitmasks::get_straight_pawn_moves_bitmask(44, false);
    ASSERT_EQ(expectedCapture, actualCapture);
    ASSERT_EQ(expectedStraight, actualStraight);
}
