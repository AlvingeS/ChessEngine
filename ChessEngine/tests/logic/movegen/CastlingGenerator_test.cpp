...
//         io::setBoardFromFen(fenTwo, bitboards, gameStateBitmasks, squaresLookup);
//         moveGenerator.genCastlingMoves(true, movelist);
...
//         io::setBoardFromFen(fenThree, bitboards, gameStateBitmasks, squaresLookup);
...
//         io::setBoardFromFen(bugFen, bitboards, gameStateBitmasks, squaresLookup);
//         moveGenerator.genCastlingMoves(true, movelist);
...
//         io::setBoardFromFen(castlingWhileInCheckWhiteFen, bitboards, gameStateBitmasks, squaresLookup);
//         moveGenerator.genCastlingMoves(true, movelist);
...
//         io::setBoardFromFen(castlingWhileInCheckBlackFen, bitboards, gameStateBitmasks, squaresLookup);
//         moveGenerator.genCastlingMoves(false, movelist);
...
//         io::setBoardFromFen(castlingThroughAttacksWhiteFen, bitboards, gameStateBitmasks, squaresLookup);
//         moveGenerator.genCastlingMoves(true, movelist);
...
//         io::setBoardFromFen(castlingThroughAttacksBlackFen, bitboards, gameStateBitmasks, squaresLookup);
//         moveGenerator.genCastlingMoves(false, movelist);
