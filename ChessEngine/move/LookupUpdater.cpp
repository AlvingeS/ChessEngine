...
LookupUpdater::LookupUpdater(board::SquaresLookup& squaresLookup) 
    : _squaresLookup(squaresLookup) 
{}

void LookupUpdater::makeCastleMove(
    const bool isWhite, 
...
void LookupUpdater::unmakeCastleMove(
    const bool wasWhite, 
...
board::PieceType LookupUpdater::getPromotionPieceType(
