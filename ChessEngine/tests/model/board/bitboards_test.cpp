...
TEST_F(BitboardsTest, ConstructorInit_WhitePawn) 
{
    ...
    bitboard actual = bitboards.get_bitboard_from_piece_type(Piece::Type::W_PAWN);
...
TEST_F(BitboardsTest, ConstructorInit_WhiteKnight) 
{
    ...
    bitboard actual = bitboards.get_bitboard_from_piece_type(Piece::Type::W_KNIGHT);
...
TEST_F(BitboardsTest, ConstructorInit_WhiteBishop) 
{
    ...
    bitboard actual = bitboards.get_bitboard_from_piece_type(Piece::Type::W_BISHOP);
...
TEST_F(BitboardsTest, ConstructorInit_WhiteRook) 
{
    ...
    bitboard actual = bitboards.get_bitboard_from_piece_type(Piece::Type::W_ROOK);
...
TEST_F(BitboardsTest, ConstructorInit_WhiteQueen) 
{
    ...
    bitboard actual = bitboards.get_bitboard_from_piece_type(Piece::Type::W_QUEEN);
...
TEST_F(BitboardsTest, ConstructorInit_WhiteKing) 
{
    ...
    bitboard actual = bitboards.get_bitboard_from_piece_type(Piece::Type::W_KING);
...
TEST_F(BitboardsTest, ConstructorInit_BlackPawn) 
{
    ...
    bitboard actual = bitboards.get_bitboard_from_piece_type(Piece::Type::B_PAWN);
...
TEST_F(BitboardsTest, ConstructorInit_BlackKnight) 
{
    ...
    bitboard actual = bitboards.get_bitboard_from_piece_type(Piece::Type::B_KNIGHT);
...
TEST_F(BitboardsTest, ConstructorInit_BlackBishop) 
{
    ...
    bitboard actual = bitboards.get_bitboard_from_piece_type(Piece::Type::B_BISHOP);
...
TEST_F(BitboardsTest, ConstructorInit_BlackRook) 
{
    ...
    bitboard actual = bitboards.get_bitboard_from_piece_type(Piece::Type::B_ROOK);
...
TEST_F(BitboardsTest, ConstructorInit_BlackQueen) 
{
    ...
    bitboard actual = bitboards.get_bitboard_from_piece_type(Piece::Type::B_QUEEN);
...
TEST_F(BitboardsTest, ConstructorInit_BlackKing) 
{
    ...
    bitboard actual = bitboards.get_bitboard_from_piece_type(Piece::Type::B_KING);
