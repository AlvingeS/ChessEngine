...
public:
    ...
    static std::vector<int>& get_sliding_piece_quiet_moves_indices();
    static std::vector<int>& get_leaping_piece_quiet_moves_indices();
...
private:
    static std::vector<int> sliding_piece_quiet_moves_indices_;
    static std::vector<int> leaping_piece_quiet_moves_indices_;
