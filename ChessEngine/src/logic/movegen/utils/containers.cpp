...
std::vector<int> Containers::sliding_piece_quiet_moves_indices_;
std::vector<int> Containers::leaping_piece_quiet_moves_indices_;
...
void Containers::init() {
    sliding_piece_quiet_moves_indices_ = std::vector<int>(32, 0);
    leaping_piece_quiet_moves_indices_ = std::vector<int>(8, 0);
...
std::vector<int>& Containers::get_sliding_piece_quiet_moves_indices()
{
    return sliding_piece_quiet_moves_indices_;
}

std::vector<int>& Containers::get_leaping_piece_quiet_moves_indices()
{
